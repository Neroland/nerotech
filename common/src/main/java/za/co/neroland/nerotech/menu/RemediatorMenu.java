...
/** Remediator menu: no machine slots — upgrade column + player inventory; energy/heat synced. */
public class RemediatorMenu extends MachineMenu {
    ...
    public RemediatorMenu(int id, Inventory playerInventory, Container container, ContainerData data) {
        super(ModMenuTypes.REMEDIATOR.get(), id, container, data, MACHINE_SLOTS);
