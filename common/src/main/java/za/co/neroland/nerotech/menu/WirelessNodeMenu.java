...
/** Wireless Power Node menu: no machine slots — upgrade column + player inventory; energy synced. */
public class WirelessNodeMenu extends MachineMenu {
    ...
    public WirelessNodeMenu(int id, Inventory playerInventory, Container container, ContainerData data) {
        super(ModMenuTypes.WIRELESS_NODE.get(), id, container, data, MACHINE_SLOTS);
