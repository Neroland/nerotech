...
- [Tech Guide](Tech-Guide.md) — the in-game handbook: 7 chapters from first power to fusion.
...
- [Fusion Reactor](Fusion-Reactor.md) — the 3³/5³/7³ multiblock: shells, fuel tiers, meltdown and
  containment breach.
- [Automation & Handoff](Automation.md) — Auto Crafter, Item Sorter, and the standard
  item-capability handoff surface NeroLogistics routes through.
